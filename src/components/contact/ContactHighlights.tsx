...
import { Cpu, Heart, Lock, type LucideIcon } from "lucide-react";
import { CONTACT_HIGHLIGHTS, CONTACT_INTRO } from "@/content/contact";
import {
  easeOutExpo,
  fadeUp,
  staggerContainer,
...
const ICONS: Record<
  (typeof CONTACT_HIGHLIGHTS)[number]["icon"],
  LucideIcon
> = {
  heart: Heart,
  chip: Cpu,
...
export function ContactHighlights() {
  return (
    <section aria-label="Contact highlights">
      <div className="bg-white pb-10 pt-8 sm:pb-12 sm:pt-10 lg:pb-14">
        <m.p
      ...
      <div className="bg-[#F7F5F2] py-10 sm:py-12 lg:py-14">
        <m.ul
          className="mx-auto grid max-w-[1200px] gap-4 px-4 sm:grid-cols-3 sm:gap-5 sm:px-6 lg:gap-6 lg:px-8 xl:max-w-[1320px] xl:px-16 2xl:max-w-[1440px] 2xl:px-24"
