...
import { ASTROGURU_SHOWCASE } from "@/content/astroguru";
import {
  easeOutExpo,
  fadeLeft,
  fadeRight,
    ...
    >
      ...
      >
        ...
        >
          <m.img
            src={astroguruMobile}
            alt="Ekatva eAstroGuru mobile app preview"
