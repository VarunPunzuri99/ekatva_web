...
import { PANCHANGAM_TODAY } from "@/content/panchangam";
import {
  easeOutExpo,
  fadeUp,
  staggerContainer,
      ...
      <div className="relative mx-auto max-w-[920px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <m.div
            ...
            viewport={viewportOnce}
          >
            {PANCHANGAM_TODAY.windows.map((win) => (
              <m.div
                key={win.label}
                variants={fadeUp}
                whileHover={{
