...
export function EventPoojaHero({ detail }: { detail: OnlinePoojaDetail }) {
  ...
  return (
    <section
      ...
      aria-labelledby="event-pooja-heading"
    >
        ...
        <div className="relative mx-auto max-w-[1200px] px-4 pt-8 sm:px-6 sm:pt-10 lg:px-8 lg:pt-12 xl:max-w-[1320px] xl:px-16 2xl:max-w-[1440px] 2xl:px-24">
          ...
          <div className="mt-6 grid items-end gap-6 lg:grid-cols-2 lg:gap-8">
            ...
            >
              ...
              >
                Online Pooja · {pooja.category || "Sacred Ritual"}
              </m.p>
              <m.h1
                id="event-pooja-heading"
                variants={fadeUp}
              ...
              >
                ...
                Live online participation · Verified pandit guidance
              </m.div>
            </m.div>
